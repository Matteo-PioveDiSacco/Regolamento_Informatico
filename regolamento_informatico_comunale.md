...
- **E' compito dell'utilizzatore mantenere in efficenza il proprio dispositivo applicando sempre gli aggiornamenti** mano a mano vengono messi a disposizione, ad esempio PortableApps, Miglioramenti Windows, client di posta Thunderbird, vedere anche la sezione al [capitolo 5](#5) per approfondimenti.  
...
- **Non è consentito modificare le impostazioni del BIOS**, del software di configurazione o l'hardware del sistema. Inoltre non è consentita nessuna operazione di forzatura fisica dei dispositivi.   
- **Gli elaboratori devono essere spenti ogni sera** prima di lasciare gli uffici e in caso di assenze prolungate dall’ufficio, salvo diversa disposizione da parte dell’Amministratore di Sistema. Ricordate che lasciare un elaboratore acceso e incustodito può essere causa di utilizzo da parte di terzi senza che vi sia la possibilità di provarne in seguito l’indebito uso (vedere anche [capitolo 6](#6) sulla sicurezza).   
- **Non è consentita l’installazione o la connessione** nel elaboratore in dotazione di alcun dispositivo esterno come ad esempio masterizzatori, modem, chiavette USB, dispositivi wireless, etc., se non con l’autorizzazione (in forma scritta tramite e-mail) dell’Amministratore di Sistema.   
...
- **Non memorizzare documenti sul desktop del PC**: il desktop come anche altre posizioni che non siano la `Home Directory` o le `Risorse di rete condivise` (vedere [capitolo 6.1](#6.1)), non sono incluse nel ciclo di Backup giornaliero (vedere [capitolo 6.4](#6.4)) e pertanto, in caso di guasto del PC, questi documenti sono destinati ad essere perduti senza che ci sia la possibilità di recupero.  
